...
import br.com.techgold.judi.bruteforce.DefaultBruteForceProtectionService;
...
import br.com.techgold.judi.services.LogLoginService;
...
public class UserAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
		...
		boolean isLoginPost = "/judi/login".equals(request.getRequestURI().trim()) && "POST".equalsIgnoreCase(request.getMethod().trim());
